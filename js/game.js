class Game {
    ...
    start() {
      ...
      bike_1 = createSprite(width / 2 - 50, height - 100);
      bike_1.addImage("bike_1", bike1_img);
      bike_1.addImage("blast",blastImg);
      bike_1.scale = 0.5;
  
      bike_2 = createSprite(width / 2 + 100, height - 100);
      bike_2.addImage("bike_2", bike2_img);
      bike_2.addImage("blast",blastImg);
      bike_2.scale = 0.5;
